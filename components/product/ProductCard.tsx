  ...
  return (
    <article>
      <Link
        ...
        className="rounded-lg shadow-lg hover:shadow-xl duration-200 hover:-translate-y-1 block group h-full"
      >
        <figure className="relative h-48 overflow-hidden rounded-t-lg">
          <button className="md:opacity-0 group-hover:opacity-100 absolute end-2 top-2 w-7 h-7 flex items-center justify-center rounded-full bg-secondary hover:bg-secondary/80 duration-150 cursor-pointer">
          ...
          <Image
            ...
            fill
            alt={product.title}
            className="object-cover block -z-10 group-hover:scale-[1.03] duration-150"
          />
          <div className="md:opacity-0 group-hover:opacity-100 md:translate-y-1 group-hover:translate-y-0 absolute bottom-0 start-0 h-[22%] mx-auto w-full bg-linear-to-b from-transparent px-2 to-foreground duration-150">
